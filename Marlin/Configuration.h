...
#define CONFIG_EXAMPLES_DIR "Bluer Plus"
...
#define STRING_CONFIG_H_AUTHOR "(Eric Prince)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//Enable GPIO pins 8 and 9 for UART /dev/ttyAML6 will be the port
...
#define CUSTOM_MACHINE_NAME "Bluer Plus"
